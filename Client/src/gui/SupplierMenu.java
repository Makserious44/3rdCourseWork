...
import gui.misc.converters.OrderTableEntry;
import gui.misc.converters.RequestTableEntry;
...
public class SupplierMenu {
    ...
    public static void switchWindow(Stage stage, User user) throws IOException {
        ...
        Parent root = FXMLLoader.load(Objects.requireNonNull(AdminMenu.class.getResource("/SupplierMenu.fxml")));
    ...
    public void initialize() {
        ...
        TablePopulator.populateTable(ordersTable, RequestType.GET_ASSOCIATED_ORDERS, currentUser, Order.class, OrderTableEntry.converter);
